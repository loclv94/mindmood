export const ContactButton = () => {
  return (
    <a
      href="https://mindmood.com/contact/"
      aria-label="CONTACT US"
      className="relative text-white font-semibold bg-brand box-border caret-transparent block float-left leading-[15.6px] max-w-full min-w-[90px] text-center border-indigo-950 my-[3px] pt-3 pb-2.5 px-4 rounded-[3px] border-b font-museomoderno"
    >
