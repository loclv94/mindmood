...
export const Header = () => {
  return (
    ...
    >
      <div className="relative box-border caret-transparent clear-both z-[3]">
      ...
      <div className="absolute text-neutral-400 bg-white box-border caret-transparent h-full w-full z-0 left-0 top-0"></div>
      <div className="absolute bg-slate-700 box-border caret-transparent h-0.5 w-[0%] rounded-r-[5px]"></div>
    </header>
  );
};
