...
export const NavMenu = () => {
  return (
    <nav
      role="navigation"
      className="box-border caret-transparent clear-both float-none h-[50px] leading-10 text-center w-full bg-gray-100 z-[100]"
    >
      <ul
        role="menu"
      ...
      >
        ...
        >
          ...
          >
            <span className="absolute border-l-brand border-r-brand box-border caret-transparent hidden h-0 left-[-3px] mt-[-3px] w-0 border-l-[3px] border-y-transparent border-y-[3px] top-[51%]"></span>
