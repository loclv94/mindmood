...
export const MobileNav = () => {
  return (
    ...
    >
      <div className="relative box-border caret-transparent float-left h-full z-[3] border-brand mr-0 pr-0 border-r-0 md:h-auto md:border-slate-300 md:mr-[25px] md:pr-[25px] md:border-r">
        <ul
          role="menu"
