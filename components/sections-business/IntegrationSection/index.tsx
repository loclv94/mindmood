    ...
    <div className="relative caret-transparent clear-left float-left min-h-px w-full z-[1] py-[50px]">
      <div className="box-border caret-transparent">
        <div className="box-border caret-transparent">
          ...
          <div className="relative clear-left float-left min-h-px w-full z-[1] mt-0 mb-5 md:w-[64.6667%] md:mt-[50px] md:mb-0">
            <section className="box-border caret-transparent">
              <div className="clear-both">
          ...
          <div className="relative float-left min-h-px w-full z-[1] ml-0 mt-0 mb-5 md:w-[29.3333%] md:ml-[6%] md:mt-[50px] md:mb-0">
              ...
              <div className="relative inline-block max-w-full align-bottom mx-auto rounded-[3px]">
                <div className="box-border caret-transparent">
                  <img
                    ...
                    className="relative aspect-[auto_300_/_169] max-w-full w-[300px] rounded-[3px]"
                  />
                </div>
              </div>
            </div>
