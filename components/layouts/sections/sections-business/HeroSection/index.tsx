...
export const HeroSection = () => {
  return (
    <div className="relative bg-white text-brand py-4 md:py-5 border-b border-gray-200">
      <Container>
        <h2 className="text-[20px] md:text-[26px] font-medium leading-[28px] md:leading-[36.4px] text-center font-museomoderno">
