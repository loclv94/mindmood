...
export const CoreValuesSection = () => {
  return (
    <Container>
      <h2 className="text-[20px] md:text-[26px] text-brand font-medium leading-[28px] md:leading-[36.4px] text-center mb-2 md:mb-2.5 font-museomoderno">
        <strong className="font-bold box-border caret-transparent">
          That's why mindmood is built with:
        </strong>
      </h2>

      <div className="w-full mt-6 md:mt-[50px] grid grid-cols-1 md:grid-cols-3 gap-[6%] gap-y-6 md:gap-y-12.5">
      ...
      <section className="box-border caret-transparent">
        <div className="clear-both">
          <h2 className="text-[20px] md:text-[26px] font-medium text-brand leading-[28px] md:leading-[36.4px] text-center mb-2 md:mb-2.5 font-museomoderno">
            <strong className="font-bold box-border caret-transparent">
      ...
      <div className="table-fixed w-full mt-6 md:mt-[50px] md:table">
            ...
            <div className="clear-both">
              <p className="text-neutral-600 text-[14px] md:text-[15.6px] font-light leading-[22px] md:leading-[24.96px] my-[10px] md:my-[13.26px] font-museo_sans_rounded">
                <Image
                  ...
                  className="relative max-w-full w-full md:w-[450px] h-auto mx-auto my-2 md:my-2.5 py-2 md:py-2.5"
                />
              </p>
            </div>
          </section>
