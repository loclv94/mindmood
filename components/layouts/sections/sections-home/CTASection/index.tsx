...
export const CTASection = () => {
  return (
    <div className="bg-white">
      <Container className="py-5 px-4 md:px-12.5">
            ...
            <div className="clear-both">
              <p className="text-neutral-600 text-[14px] md:text-[15.6px] font-light leading-[22px] md:leading-[24.96px] my-[10px] md:my-[13.26px] font-museo_sans_rounded">
                <img
                  ...
                  className="relative aspect-[auto_350_/_233] clear-both max-w-full w-full max-w-[280px] md:w-[350px] mx-auto my-2 md:my-2.5 py-2 md:py-2.5"
                />
              </p>
            </div>
          </section>
