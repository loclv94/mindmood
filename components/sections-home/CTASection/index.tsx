        ...
        <Card>
          ...
          <div className="box-border caret-transparent clear-both text-center">
            <a
              ...
              className="relative font-semibold bg-white box-border caret-transparent inline-block leading-[15.6px] max-w-full min-w-[90px] border-brand my-[3px] pt-3 pb-2.5 px-4 border-2 border-solid font-museomoderno hover:text-white hover:bg-brand"
            >
