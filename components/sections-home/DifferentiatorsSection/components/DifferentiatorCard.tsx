export type DifferentiatorCardProps = {
  imageUrl: string;
  imageAlt?: string;
  variant: string;
};

export const DifferentiatorCard = (props: DifferentiatorCardProps) => {
  return (
    <div
      className={`relative bg-white shadow-[rgb(209,215,218)_0px_0px_10px_0px] box-border caret-transparent block min-h-px align-top w-full z-[1] mt-0 mb-5 p-[3%] rounded-[25px] md:table-cell md:w-[47%] md:mt-[50px] md:mb-0 ${props.variant}`}
    >
